...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const popconfirmPopperContentRef = ref()
    ...
    provide(DROPDOWN_INJECTION_KEY, {
      ...
      updatePopconfirmPopperContentRef(
        popconfirmPopperContentRefCurrent: HTMLElement
      ) {
        if (popconfirmPopperContentRefCurrent) {
          popconfirmPopperContentRef.value = popconfirmPopperContentRefCurrent
        }
      },
      popconfirmPopperContentRef,
    })
